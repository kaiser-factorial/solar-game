...
A space-exploration game designed by two excellent nephews (and their aunt).
Explore the planets, collect treasure, fight monsters, beat each world's boss
to win its **orb** — and one day, jump to another solar system for the hardest
boss of all.
...
- **Move** — arrows or WASD · **Jump** — space · **Attack** — X or J
- **E** — use (fly home at your rocket) · **F** — eat food · **I** — open your bag
- Beat a planet's boss → earn its orb **+1 heart**, and unlock the next world.
...
- Backend: Supabase (`scouts_profiles`, `scouts_saves` tables, RLS-protected)
  in the shared "scratchpad" project. Config in `src/lib/config.ts`.
